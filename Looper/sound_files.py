...
#       First digit is instrument, then pattern, then effect.
    ...
    sounds = {
        ...
        "222" : pygame.mixer.Sound("Audio_Files/Track3.wav"),
        "002" : pygame.mixer.Sound("Audio_Files/2_SECOND_PIANO.wav"),
        "020" : pygame.mixer.Sound("Audio_Files/Track1.wav"),
        #"200" : pygame.mixer.Sound("Audio_Files/techno.wav"),
        #"300" : pygame.mixer.Sound("Audio_Files/keys.wav"),
        #"030" : pygame.mixer.Sound("Audio_Files/highs.wav"),
        #"003" : pygame.mixer.Sound("Audio_Files/sax.wav"),
